...
<html>
  ...
  <body>
    <form>
                ...
                <div><div class="eg">期刊名</div> <input type="text"  class="eg0" name="publisher"/></div>
                <div><div class="eg">编辑</div> <textarea rows="3" cols="20"  class="eg2" name="doc_abstract"></textarea></div>
